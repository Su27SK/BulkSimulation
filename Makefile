BulkTest: BulkNode.o BulkLink.o BulkSession.o BulkGraphEdge.o BulkGraphNode.o BulkFile.o Graph.o BulkPacket.o BulkPackets.o BulkPool.o Scheduler.o TimerHandler.o Process.o BulkNetwork.o
	g++  BulkNode.o BulkLink.o BulkSession.o BulkGraphEdge.o BulkGraphNode.o BulkFile.o Graph.o BulkPacket.o BulkPackets.o BulkPool.o Scheduler.o TimerHandler.o Process.o BulkNetwork.o -o BulkTest -g BulkTest.c
