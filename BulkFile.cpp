 ...
 */
pathInfo* BulkFile:: _pathinfo(string sDirname, string sBasename, string sExtension)
{
	if (sDirname == "") {
 ...
 * @param {string} s
 */
string BulkFile::_removeForbiddenChar(string* s)
{
	string illegalChars = "\\/:?\"<>|";
	string::iterator it;
 ...
 */
void BulkFile::_setFileName(pathInfo* fileNameInfo, string sFileName)
{
 ...
 * @return {string}
 */
string BulkFile::_getFileFullPath(pathInfo* fileNameInfo)
{
 ...
 * @return {string}
 */
string BulkFile::_ItoS(int source)
{
	stringstream ss;
	string str;
	ss<<source;
 ...
 * @return {boolean}
 */
bool BulkFile::_fileExisted(string filePath)
{
	std::fstream foo;
 ...
 */
void BulkFile::addFile(string sBasename, string sDirname)
{
 ...
 * @return {BulkFile}
 */
BulkFile& BulkFile::setTempDirname(string tempDir)
{
 ...
 * @return {string}
 */
string BulkFile::getTempDirname() const
{
 ...
 * @return {string}
 */
string BulkFile::getFilePath() const
{
